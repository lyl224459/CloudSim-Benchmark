...
class RealtimeMetricsCollectorTest {
    ...
    private fun assertProjectedBrokerMetrics(result: RealtimeAlgorithmResult) {
        ...
        assertThat(result.deadlineRejectedCount).isEqualTo(31)
        assertThat(result.deadlineDegradedCount).isEqualTo(32)
        assertThat(result.deadlineRetryLaterCount).isEqualTo(33)
        assertThat(result.deadlineMissAcceptedCount).isEqualTo(34)
        assertThat(result.rescheduleAttemptCount).isEqualTo(35)
        assertThat(result.rescheduleSuccessCount).isEqualTo(36)
        assertThat(result.rescheduleFailureCount).isEqualTo(37)
        assertThat(result.averageRescheduleDelay).isEqualTo(1.75)
    ...
    private fun stubQueueAutoscalingMetrics(broker: RealtimeBroker) {
        ...
        whenever(broker.getDeadlineRejectedCount()).thenReturn(31)
        whenever(broker.getDeadlineDegradedCount()).thenReturn(32)
        whenever(broker.getDeadlineRetryLaterCount()).thenReturn(33)
        whenever(broker.getDeadlineMissAcceptedCount()).thenReturn(34)
        whenever(broker.getRescheduleAttemptCount()).thenReturn(35)
        whenever(broker.getRescheduleSuccessCount()).thenReturn(36)
        whenever(broker.getRescheduleFailureCount()).thenReturn(37)
        whenever(broker.getAverageRescheduleDelay()).thenReturn(1.75)
