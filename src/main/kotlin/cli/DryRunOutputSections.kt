...
private fun realtimeCoreSchedulingValues(scheduling: RealtimeSchedulingConfig): List<Any?> =
    listOf(
        ...
        scheduling.eventObservationEnabled,
        ...
        scheduling.scaleCooldown,
        scheduling.warmPoolSize,
        scheduling.minActiveVms,
        scheduling.scaleInDrainEnabled,
        scheduling.arrivalRateWindow,
        scheduling.predictiveLookahead,
...
internal fun printPhysicalTopology(
    ...
    output.result(
        ...
        scheduling.networkBandwidthSharingEnabled,
        scheduling.storageIopsSharingEnabled,
        scheduling.imagePullQueueEnabled,
