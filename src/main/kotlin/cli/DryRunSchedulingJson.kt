...
internal fun JsonObjectBuilder.putRealtimeScheduling(scheduling: RealtimeSchedulingConfig) {
    putJsonObject("scheduling") {
        ...
        put("deadlineAdmissionEnabled", scheduling.deadlineAdmissionEnabled)
        put("deadlineType", scheduling.deadlineType)
        put("deadlineMissAction", scheduling.deadlineMissAction)
        put("reschedulingEnabled", scheduling.reschedulingEnabled)
        put("reschedulingInterval", scheduling.reschedulingInterval)
        ...
        put("autoscalingPolicy", scheduling.autoscalingPolicy)
        put("autoscalingEvaluationInterval", scheduling.autoscalingEvaluationInterval)
        ...
        put("scaleCooldown", scheduling.scaleCooldown)
        put("scaleOutBatchSize", scheduling.scaleOutBatchSize)
        put("warmPoolSize", scheduling.warmPoolSize)
        put("minActiveVms", scheduling.minActiveVms)
        put("scaleInDrainEnabled", scheduling.scaleInDrainEnabled)
        put("arrivalRateWindow", scheduling.arrivalRateWindow)
        put("predictiveLookahead", scheduling.predictiveLookahead)
        put("scalePressureThreshold", scheduling.scalePressureThreshold)
        put("dynamicVmCostPerSecond", scheduling.dynamicVmCostPerSecond)
...
private fun JsonObjectBuilder.putTopologyScheduling(scheduling: RealtimeSchedulingConfig) {
    ...
    put("cpuOvercommitRatio", scheduling.cpuOvercommitRatio)
    ...
    put("networkBandwidthSharingEnabled", scheduling.networkBandwidthSharingEnabled)
    put("storageIopsSharingEnabled", scheduling.storageIopsSharingEnabled)
    put("imagePullQueueEnabled", scheduling.imagePullQueueEnabled)
    put("noisyNeighborPenaltyWeight", scheduling.noisyNeighborPenaltyWeight)
