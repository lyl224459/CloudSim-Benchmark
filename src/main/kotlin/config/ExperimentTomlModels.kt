...
data class RealtimeSchedulingConfig(
    ...
    val cpuOvercommitRatio: Double = 1.0,
    val hostRamCapacity: Double = 0.0,
    val hostBwCapacity: Double = 0.0,
    val hostIoCapacity: Double = 0.0,
    val networkBandwidthSharingEnabled: Boolean = false,
    val storageIopsSharingEnabled: Boolean = false,
    val imagePullQueueEnabled: Boolean = false,
    val noisyNeighborPenaltyWeight: Double = 0.0,
