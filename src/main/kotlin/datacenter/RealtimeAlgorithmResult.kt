...
data class RealtimeAlgorithmResult(
    ...
    val dependencyBlockedCount: Int get() = metrics.intValue(RealtimeMetricKey.DEPENDENCY_BLOCKED_COUNT)
    val dependencyReleasedCount: Int get() = metrics.intValue(RealtimeMetricKey.DEPENDENCY_RELEASED_COUNT)
    val dependencyRejectedCount: Int get() = metrics.intValue(RealtimeMetricKey.DEPENDENCY_REJECTED_COUNT)
