...
private fun brokerMetricPairs(context: BrokerMetricContext): List<MetricPair> =
    listOf(
        ...
        RealtimeMetricKey.DEPENDENCY_BLOCKED_COUNT to context.broker.getDependencyBlockedCount(),
        RealtimeMetricKey.DEPENDENCY_RELEASED_COUNT to context.broker.getDependencyReleasedCount(),
        RealtimeMetricKey.DEPENDENCY_REJECTED_COUNT to context.broker.getDependencyRejectedCount(),
        RealtimeMetricKey.RESCHEDULE_ATTEMPT_COUNT to context.broker.getRescheduleAttemptCount(),
        RealtimeMetricKey.RESCHEDULE_SUCCESS_COUNT to context.broker.getRescheduleSuccessCount(),
        RealtimeMetricKey.RESCHEDULE_FAILURE_COUNT to context.broker.getRescheduleFailureCount(),
        RealtimeMetricKey.AVERAGE_RESCHEDULE_DELAY to context.broker.getAverageRescheduleDelay(),
        ...
        RealtimeMetricKey.AVERAGE_NETWORK_TRANSFER_DELAY to context.broker.getAverageNetworkTransferDelay(),
        RealtimeMetricKey.IMAGE_CACHE_HIT_RATE to context.broker.getImageCacheHitRate(),
        RealtimeMetricKey.AVERAGE_NOISY_NEIGHBOR_PRESSURE to context.broker.getAverageNoisyNeighborPressure(),
