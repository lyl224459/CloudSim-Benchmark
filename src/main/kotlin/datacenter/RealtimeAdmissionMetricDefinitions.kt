...
internal object RealtimeAdmissionMetricDefinitions {
    val metrics: List<RealtimeMetricDefinition> =
        listOf(
            ...
            realtimeMetric(
                RealtimeMetricKey.DEPENDENCY_BLOCKED_COUNT,
                "DependencyBlockedCount",
                "count",
                RealtimeMetricDirection.LOWER_IS_BETTER,
                "DAG 依赖未满足而暂缓进入调度链路的任务数。",
                RealtimeMetricValueKind.INT,
            ),
            realtimeMetric(
                RealtimeMetricKey.DEPENDENCY_RELEASED_COUNT,
                "DependencyReleasedCount",
                "count",
                RealtimeMetricDirection.HIGHER_IS_BETTER,
                "前驱全部成功后被释放回实时调度链路的任务数。",
                RealtimeMetricValueKind.INT,
            ),
            realtimeMetric(
                RealtimeMetricKey.DEPENDENCY_REJECTED_COUNT,
                "DependencyRejectedCount",
                "count",
                RealtimeMetricDirection.LOWER_IS_BETTER,
                "因前驱失败、拒绝、取消或超时而被级联拒绝的任务数。",
                RealtimeMetricValueKind.INT,
            ),
            realtimeMetric(
                RealtimeMetricKey.RESCHEDULE_ATTEMPT_COUNT,
                "RescheduleAttemptCount",
                "count",
                RealtimeMetricDirection.LOWER_IS_BETTER,
                "周期性重调度检查中尝试重新安排任务的次数。",
                RealtimeMetricValueKind.INT,
            ),
            realtimeMetric(
                RealtimeMetricKey.RESCHEDULE_SUCCESS_COUNT,
                "RescheduleSuccessCount",
                "count",
                RealtimeMetricDirection.HIGHER_IS_BETTER,
                "周期性重调度成功迁移或重排到新 VM 的次数。",
                RealtimeMetricValueKind.INT,
            ),
            realtimeMetric(
                RealtimeMetricKey.RESCHEDULE_FAILURE_COUNT,
                "RescheduleFailureCount",
                "count",
                RealtimeMetricDirection.LOWER_IS_BETTER,
                "周期性重调度尝试后未找到更优 VM 或未执行迁移的次数。",
                RealtimeMetricValueKind.INT,
            ),
            realtimeMetric(
                RealtimeMetricKey.AVERAGE_RESCHEDULE_DELAY,
                "AvgRescheduleDelay",
                "seconds",
                RealtimeMetricDirection.LOWER_IS_BETTER,
                "成功重调度产生的平均决策/迁移延迟。",
